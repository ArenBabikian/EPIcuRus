...
function [assumptionArray,parent_constraints,interAssum] = dtGenAssum(tv,Olt,inputnames,categorical,assume_options)
 
%   dtGenAssum learns assumptions from all the previously generated test cases.
