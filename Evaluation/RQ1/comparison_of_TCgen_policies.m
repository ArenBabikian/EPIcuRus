            ...
            for run=runs
                ...
                for algorithm=algorithms
                    ...
                    if isfolder(runfolder)
                        disp(runfolder);
                        total=total+1;
                        disp(strcat('Benchmark/',model,filesep,prefix,filesep,requirement,filesep,'UR',filesep,algorithm,filesep,"Run",num2str(run)));
                        if isfile(strcat('Benchmark/',model,filesep,prefix,filesep,requirement,filesep,'UR',filesep,algorithm,filesep,"Run",num2str(run),filesep,"validEPtime.txt"))
                            result=1;
                        else
                            result=0;
                        end
