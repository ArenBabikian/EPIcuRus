function [tree,lastnode,nbrConj,nbrDisj]=maketree(level,oplist,init,depthnodes,lastnode,type,parentType,parentCP,maxNbrConj,maxNbrDisj,nbrConj,nbrDisj,cp,opt,gp_opt)
%   Copyright (C) 2003-2015 Sara Silva (sara@fc.ul.pt)
%   This file is part of the GPLAB Toolbox
% This file is part of GP-utils
% Copyright © [2020] – [2021] University of Luxembourg.
%MAKETREE    Creates a syntax tree using the following rules:
...
if strcmp(type,'0')
    ...
    if init   
       ...
       % we must choose a non terminal that has the root type.   
        ...
        % WARNING : this is added to remove conjunctions 
        %nonTerminal_rootType_index=setdiff(nonTerminal_rootType_index,4);
